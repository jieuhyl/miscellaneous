rm(list = ls())
setwd("C:/Users/Jie.Hu/Desktop/Segmentation/0331")
#set.seed(1337)
...
# read data
df <- read.csv('us04388online-mall-final.csv', header=T, stringsAsFactors=FALSE)
...
write.csv(df, file="seg_output_watch_4.csv", row.names = FALSE)
